...
version: 1.0.1
*/
import { throttle, TINY_NUM, sum, findIndex, getShapeDirection, getDist } from '@daybrush/utils';
...
function getIntersectionPointsByConstants(linearConstants1, linearConstants2) {
  ...
  if (isZeroA && isZeroB) {
    ...
    if (y1 !== y2) {
      ...
      return [[-Infinity, tinyThrottle(y1)], [Infinity, tinyThrottle(y1)]];
    }
  } else if (isZeroB) {
    // a1 * x + c1 = 0
    // a2 * x + c2 = 0
    ...
    if (x1 !== x2) {
      ...
      return [[tinyThrottle(x1), -Infinity], [tinyThrottle(x1), Infinity]];
    }
  } else if (a1 === 0) {
    // b1 * y + c1 = 0
    // y = - c1 / b1;
